...
<audio id="admusic" controls style="display:none;" preload='none'>
    ...
    <section>
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    <div class="extrabtn" data-gametimeid="<?= $data->game_time_id ?>">
                        <p style="margin:0"><span id="changed-no<?=$data->id ?>"><?=@$number[0]->number ?? '-' ; ?></span></p>
        ...
        <div class="bottom-footer">
            <button onclick="window.location.href='mumbai-result.php'">See Result</button>
        </div>
...
function handleMessage(message) {
  try {
    ...
    currentgameid = data.game_time_id;
