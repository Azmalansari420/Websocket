...
class All_times extends CI_Controller
{

	//-define everything for here
	protected $arr_values = array(
						   	'page_title'=>'All Times',
						   	'table_name'=>'all_times',
						   	'upload_path'=>'media/uploads/all_times/',
						   	'load_path'=>'admin/all_times/',
						   	'redirect_path'=>'admin_con/all_times/',
						   	'back_url'=>'all_times',
						   	'add_url'=>'all_times',
						   	'edit_url'=>'all_times',
						   	'delete_url'=>'all_times',
						   	'view_url'=>'all_times',
						   	'table_url'=>'admin/all_times/table',
						   	'status_value'=>'all_times',
						   	'multiple_delete'=>'admin_con/all_times/delete_all',
						   	'pagination_url'=>'admin_con/all_times/get_table_data',
						   	'controller_name'=>'all_times',
						   	'page_name'=>'all_times.php',
						   	'pagination_limit'=>'15',
						   	'formURL'=>'admin_con/all_times/UpdateData',
						   ); 
   ...
   //--check user login or not
	...
	public function get_table_data() 
	{
	    ...
	    $this->db->group_start();
	    $this->db->like('time', $search);
	    $this->db->or_like('id', $search);
	    $this->db->or_like('time_string', $search);
	    $this->db->group_end();
