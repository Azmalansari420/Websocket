...
class Drivers extends CI_Controller
{
	...
	protected $arr_values = array(
						   	...
						   	'load_path'=>'admin/drivers/',
						   	'redirect_path'=>'admin_con/drivers/',
						   	'back_url'=>'drivers',
						   	'add_url'=>'drivers',
						   	'edit_url'=>'drivers',
						   	'delete_url'=>'drivers',
						   	'view_url'=>'drivers',
						   	'table_url'=>'admin/drivers/table',
						   	'status_value'=>'drivers',
						   	'multiple_delete'=>'admin_con/drivers/delete_all',
						   	'pagination_url'=>'admin_con/drivers/get_table_data',
						   	'controller_name'=>'drivers',
						   	'page_name'=>'drivers.php',
						   	'pagination_limit'=>'15',
						   ); 
   ...
   //--check user login or not
	...
	function edit()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			if($_FILES['profile_image']['name']!='')
			{
				$image = time().'.'.explode(".", $_FILES['profile_image']['name'])[1];
				$path = $this->arr_values['upload_path'].$image;
				move_uploaded_file($_FILES['profile_image']['tmp_name'],$path);
			}
			else
			{
				$image = $_POST['oldprofile_image'];
			}
