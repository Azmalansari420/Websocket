...
class Car_name extends CI_Controller
{

	//-define everything for here
	protected $arr_values = array(
						   	'page_title'=>'Cars Name',
						   	'table_name'=>'car_name',
						   	'upload_path'=>'media/uploads/car_name/',
						   	'load_path'=>'admin/car_name/',
						   	'redirect_path'=>'admin_con/car_name/',
						   	'back_url'=>'car_name',
						   	'add_url'=>'car_name',
						   	'edit_url'=>'car_name',
						   	'delete_url'=>'car_name',
						   	'view_url'=>'car_name',
						   	'table_url'=>'admin/car_name/table',
						   	'status_value'=>'car_name',
						   	'multiple_delete'=>'admin_con/car_name/delete_all',
						   	'pagination_url'=>'admin_con/car_name/get_table_data',
						   	'controller_name'=>'car_name',
						   	'page_name'=>'car_name.php',
						   	'pagination_limit'=>'15',
						   ); 
...
//---------------------status
    ...
    {   
        ...
        $city = $this->db->get_where('car_brand',array('car_type_id'=>$car_type_id,))->result_object();
        $html = '<option disabled selected>Select Car Brand</option>';
