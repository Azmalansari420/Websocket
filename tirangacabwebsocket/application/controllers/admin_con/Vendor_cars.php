...
class Vendor_cars extends CI_Controller
{

	//-define everything for here
	protected $arr_values = array(
						   	'page_title'=>'Vendor Cars',
						   	'table_name'=>'vendor_cars',
						   	'upload_path'=>'media/uploads/',
						   	'load_path'=>'admin/vendor_cars/',
						   	'redirect_path'=>'admin_con/vendor_cars/',
						   	'back_url'=>'vendor_cars',
						   	'add_url'=>'vendor_cars',
						   	'edit_url'=>'vendor_cars',
						   	'delete_url'=>'vendor_cars',
						   	'view_url'=>'vendor_cars',
						   	'table_url'=>'admin/vendor_cars/table',
						   	'status_value'=>'vendor_cars',
						   	'multiple_delete'=>'admin_con/vendor_cars/delete_all',
						   	'pagination_url'=>'admin_con/vendor_cars/get_table_data',
						   	'controller_name'=>'vendor_cars',
						   	'page_name'=>'vendor_cars.php',
						   	'pagination_limit'=>'15',
						   ); 
   ...
   //--check user login or not
	...
	// 			$bimage = time().'.'.explode(".", $_FILES['profile_image']['name'])[1];
	...
	public function get_table_data() 
	{
	    ...
	    $this->db->group_start();
	    $this->db->like('car_number', $search);
	...
	function edit()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$car_perkm_price = $this->input->post('car_perkm_price');
			$reject_msg = $this->input->post('reject_msg');
			$status = $this->input->post('status');						
			$modifieddate = date('Y-m-d H:i:s');
			/*upodate dtaa*/
			$updatedata = array(				
				"car_perkm_price"=>$car_perkm_price,
