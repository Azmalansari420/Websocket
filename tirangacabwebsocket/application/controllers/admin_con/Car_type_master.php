...
class car_type_master extends CI_Controller
{

	//-define everything for here
	protected $arr_values = array(
						   	'page_title'=>'Cars Type Master',
						   	'table_name'=>'car_type_master',
						   	'upload_path'=>'media/uploads/car_type_master/',
						   	'load_path'=>'admin/car_type_master/',
						   	'redirect_path'=>'admin_con/car_type_master/',
						   	'back_url'=>'car_type_master',
						   	'add_url'=>'car_type_master',
						   	'edit_url'=>'car_type_master',
						   	'delete_url'=>'car_type_master',
						   	'view_url'=>'car_type_master',
						   	'table_url'=>'admin/car_type_master/table',
						   	'status_value'=>'car_type_master',
						   	'multiple_delete'=>'admin_con/car_type_master/delete_all',
						   	'pagination_url'=>'admin_con/car_type_master/get_table_data',
						   	'controller_name'=>'car_type_master',
						   	'page_name'=>'car_type_master.php',
						   	'pagination_limit'=>'15',
						   ); 
   ...
   //--check user login or not
	...
	function add()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$slug = slug($name);									
			$per_km_charge = $this->input->post('per_km_charge');			
			$per_min_charge = $this->input->post('per_min_charge');			
			$waiting_time_charge = $this->input->post('waiting_time_charge');		
