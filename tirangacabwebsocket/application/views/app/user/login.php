    ...
    margin: 0 auto;
      ...
      <div class="auth-container">
         ...
         <div class="text-center mb-3">
            ...
            <h1 class="h1title">For a One Way Outstaion Trip, Pay for one way only.</h1>
         </div>
         <!-- Sign In Form -->
         <form class="auth-form" action="<?=base_url('api/auth/login') ?>" method="post">
            ...
            <input type="hidden" name="selectedRole" value="1" id="selectedRole">
            <div class="mb-3">
               ...
               <div class="input-group">
                  ...
                  <input type="tel" class="form-control border-start-0" id="mobile" placeholder="Enter Mobile number" value="1122334455">
               </div>
            </div>
            ...
            <div class="mb-3">
               ...
               <div class="input-group">
                  ...
                  <input type="password" class="form-control border-start-0 border-end-0" id="password" value="123456" placeholder="Enter Password" >
            ...
            <div class="d-grid gap-2 mb-4">
               <a href="javascript:void(0);" class="btn-app pulse-animation p-2 fw-bold btn login-btn text-white">Sign In</a>
            </div>
            <!-- Social Sign In -->

            <div class="text-center">
               <p class="mb-0">Don't have an account? <a href="register.php" class="text-primary-color text-decoration-none">Sign Up</a></p>
            </div>
...
<script>
    ...
    function login_distibuter()
    {
        ...
        form.append("selectedRole", selectedRole);
