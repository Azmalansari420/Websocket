         ...
         <div class="search-card p-3">
            ...
            <form action="trip-details.php">
               ...
               <div class="mb-3">
                 ...
                 <div class="input-group">
                   <span class="input-group-text"><i class="bi bi-geo-alt text-primary-color"></i></span>
                   <input id="location-input" type="text" class="form-control" placeholder="Current Location">
                 </div>
               </div>
               ...
               <div class="mb-3" id="destinationCityGroup" style="display: none;">
                  ...
                  <div class="input-group">
                     ...
                     <input id="drop-location-input" type="text" class="form-control" placeholder="Drop Location">
                  </div>
               </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAbkTIfRm-dSdJkWFBk0gjJ0QyCyIt040k&libraries=places"></script>
...
function calculateDistance(origin, destination) {
  ...
  // window.onload = initMap;
   ...
   // Update switch button in header
   ...
   // Remove old tab highlight logic
   ...
   initMap(); // Load map
   selectMainTab('local'); // Set default tab
};
</script>
