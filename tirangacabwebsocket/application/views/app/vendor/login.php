      ...
      <div class="auth-container">
         ...
         <form class="auth-form" action="<?=base_url('api/auth/login') ?>" method="post">
            ...
            <div class="d-flex justify-content-center">
               <div class="form-check mb-3" style="margin-right: 10px;">
            ...
            <div class="mb-3">
               ...
               <div class="input-group">
                  ...
                  <input type="tel" class="form-control border-start-0" id="mobile" placeholder="Enter Mobile number" value="123456789">
               </div>
            </div>
