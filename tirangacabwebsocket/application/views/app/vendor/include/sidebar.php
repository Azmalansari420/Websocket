...
<div class="sidebar" id="sidebar">
         ...
         <div class="sidebar-menu">
            ...
            <a href="car-list.php" class="sidebar-menu-item <?php if($page_name=='car-list.php') echo 'active'; ?>">
            <i class="bi bi-wallet"></i>
            <span>My Cars </span>
            </a>           

            <a href="otp.php" class="sidebar-menu-item <?php if($page_name=='otp.php') echo 'active'; ?>">
            <i class="bi bi-wallet"></i>
            <span>OTP</span>
            </a>
