                  ...
                  <div class="card m-b-15">
                     <div class="row card-body">
                        ...
                        <div class="col-6 form-group">
                           ...
                           <input type="text" class="form-control" name="description" value="<?=$EDITDATA[0]->description ?>">
                        </div>

                        <div class="col-4 form-group">
                           <label>Per KM/Charges </label>
                           <input type="number" class="form-control" name="per_km_charge" value="<?=$EDITDATA[0]->per_km_charge ?>"/>
                        </div>
                        <div class="col-4 form-group">
                           <label>Per Minute/Charges </label>
                           <input type="number" class="form-control" name="per_min_charge" value="<?=$EDITDATA[0]->per_min_charge ?>"/>
                        </div>
                        
                        <div class="col-4 form-group">
                           <label>Waiting Time/Charges </label>
                           <input type="number" class="form-control" name="waiting_time_charge" value="<?=$EDITDATA[0]->waiting_time_charge ?>"/>
                        </div>
