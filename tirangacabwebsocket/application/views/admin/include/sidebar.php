...
<sidebar id="sidebar" class="app-sidebar">
   <div data-scrollbar="true" data-height="100%">
      <ul class="nav">
         ...
         <li class="<?php if($currentURL==base_url('admin_con/car_type_master/listing')) echo 'active'; ?>">
            <a href="<?php echo base_url('admin_con/car_type_master/listing');?>">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
               <span class="nav-text">Cars Type Master</span>
            </a>
         </li>

         <!-- <li class="<?php if($currentURL==base_url('admin_con/carsbrand/listing')) echo 'active'; ?>">
            <a href="<?php echo base_url('admin_con/carsbrand/listing');?>">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
               <span class="nav-text">Cars Brand</span>
            </a>
         </li> -->
         
         <li class="<?php if($currentURL==base_url('admin_con/car_name/listing')) echo 'active'; ?>">
            <a href="<?php echo base_url('admin_con/car_name/listing');?>">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
               <span class="nav-text">Cars Name</span>
            </a>
         </li>

         <li class="<?php if($currentURL==base_url('admin_con/vendors/listing')) echo 'active'; ?>">
            <a href="<?php echo base_url('admin_con/vendors/listing');?>">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
               <span class="nav-text">Vendors</span>
            </a>
         </li>
         
         <li class="<?php if($currentURL==base_url('admin_con/vendor_cars/listing')) echo 'active'; ?>">
            <a href="<?php echo base_url('admin_con/vendor_cars/listing');?>">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
               <span class="nav-text">Vendors Cars</span>
            </a>
         </li>


         <li class="<?php if($currentURL==base_url('admin_con/drivers/listing')) echo 'active'; ?>">
            <a href="<?php echo base_url('admin_con/drivers/listing');?>">
               <span class="nav-icon"><i class="fa fa-cog bg-black text-white"></i></span>
