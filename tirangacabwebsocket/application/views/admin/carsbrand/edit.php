                  ...
                  <div class="card m-b-15">
                     <div class="row card-body">
                        <div class="col-4 form-group m-b-0">
                           <label>Select Car Type Master</label>
                           <select class="selectpicker  form-control" required name="car_type_id" data-style="btn-default" data-live-search="true" >
                              <?php
                              $car_type_master = $this->db->get_where('car_type_master',array('status'=>1))->result_object();
                              foreach($car_type_master as $data)
                                 { ?>
